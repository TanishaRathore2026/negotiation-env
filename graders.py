...
returns a score in (0.0, 1.0) — strictly open interval.
"""
...
def grade_episode(env: NegotiationEnvironment) -> float:
    ...
    # Strictly between 0 and 1 (not 0.0, not 1.0)
